...
public class Meeting {
    ...
    public Meeting(String meeting_title, String meeting_desc, LocalDateTime meeting_date) {
        this.meeting_title = meeting_title;
        this.meeting_desc = meeting_desc;
        this.meeting_date = meeting_date;
    }

    public Meeting(int meeting_id, String meeting_title, String meeting_desc, LocalDateTime meeting_date) {
